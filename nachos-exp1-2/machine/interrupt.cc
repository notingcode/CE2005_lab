...
//----------------------------------------------------------------------
// RemoveNextPening
// 	Removes one leading interrupt from the pending list
// 	assuming there is only one interrupt in the pending list.
// 	(No need to sort the interrupts)
//----------------------------------------------------------------------

void
Interrupt::RemoveNextPending(){
	pending->Remove();
	printf("List of pending interrupt emptied\n");
}
