...
// fill your cod
Lock *lock = new Lock("JustaLock");
Semaphore *mutex = new Semaphore("Simple_Semaphore", 1);
...
void TestConsistency()
{
	...
	//fill your code
	Thread *t1 = new Thread("Inc_Consistent_0");
	Thread *t2 = new Thread("Inc_Consistent_1");
	Thread *t3 = new Thread("Dec_Consistent_0");
	Thread *t4 = new Thread("Dec_Consistent_1");
